...
if (!class_exists('Shipit_Settings')) {
  class Shipit_Settings  {
    ...
    function callback_warning($args) {
      echo '<div class="notice notice-success is-dismissible"><p>' . $args['desc'] . '</p></div>';
    }

    function callback_multiselect($args) {
      $options = $args['options'];
      $selected_values = array();
      $settings = get_option($args['section']);
      $settings = maybe_unserialize($settings);
      $res = isset($settings[$args['id']]) ? $settings[$args['id']] : array();
      ...
      echo '<select type="multiselect" id="' . $args['id'] . '" name="' . $args['section'] . '[' . $args['id'] . '][]" multiple>';
